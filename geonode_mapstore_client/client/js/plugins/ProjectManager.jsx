...
import * as epics from '../../MapStore2/web/client/epics/featuregrid';
import * as featuregrid from '../../MapStore2/web/client/reducers/featuregrid';

import Grid from '../../MapStore2/web/client/components/data/featuregrid/FeatureGrid';
import {paginationInfo, describeSelector, wfsURLSelector, typeNameSelector} from '../../MapStore2/web/client/selectors/query';
import {modeSelector, changesSelector, newFeaturesSelector, hasChangesSelector, selectedFeaturesSelector, getDockSize} from '../../MapStore2/web/client/selectors/featuregrid';
import { toChangesMap} from '../../MapStore2/web/client/utils/FeatureGridUtils';
import {getPanels, getHeader, getFooter, getDialogs, getEmptyRowsView, getFilterRenderers} from '../../MapStore2/web/client/plugins/featuregrid/panels/index';
import BorderLayout from '../../MapStore2/web/client/components/layout/BorderLayout';
const EMPTY_ARR = [];
const EMPTY_OBJ = {};
import {gridTools, gridEvents, pageEvents, toolbarEvents} from '../../MapStore2/web/client/plugins/featuregrid/index';
import { initPlugin, sizeChange, setUp} from '../../MapStore2/web/client/actions/featuregrid';
...
const ProjectManagerPlugin = compose(
    connect(selector,
        (dispatch) => ({
...
export default createPlugin('ProjectManager', {
    component: ProjectManagerPlugin,
    epics,
    reducers: {
        featuregrid
    },
