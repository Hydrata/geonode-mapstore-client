...
class HydrologyDetailTimeSeriesClass extends React.Component {
    static propTypes = {
    }
...
const HydrologyDetailTimeSeries = connect(mapStateToProps, mapDispatchToProps)(HydrologyDetailTimeSeriesClass);
