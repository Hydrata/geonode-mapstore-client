/**
 * Scoped karma config for the AUTHKEY warm-up probe suite (TASK-2659).
 ...
 *
 * Run: npx karma start karma.conf.authkey.js --colors
 * The wave gate is still the FULL `npm run test`; this exists so a red-first
 * cycle on the probe module costs a minute instead of an hour.
 */
...
const testWebpackPath = path.join(appDirectory, 'tests-authkey-scoped.webpack.js');
