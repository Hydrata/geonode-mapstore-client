/**
 * Scoped karma config for clickDisambiguation + IdentifyContainer (epic 1969 W2-corrective-4).
 * Inherits all Hydrata performance overrides from karma.conf.single-run.js
 * but overrides the test entry to point at a single test file.
 */
...
const testWebpackPath = path.join(appDirectory, 'tests-clickdisambig-scoped.webpack.js');
