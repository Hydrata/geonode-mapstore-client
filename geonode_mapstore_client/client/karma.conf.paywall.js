/**
 * Scoped karma config for the PAYWALL / money-path suite (TASK-2425 W2.8).
 ...
 *
 * Run: npx karma start karma.conf.paywall.js --colors
 * The wave gate is still the FULL `npm run test`; this exists so a red-first
 * cycle on the money path costs a minute instead of an hour.
 */
...
const testWebpackPath = path.join(appDirectory, 'tests-paywall-scoped.webpack.js');
