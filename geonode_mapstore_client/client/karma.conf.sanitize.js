/**
 * Scoped karma config for SanitizeUtils (TASK-2068, GEO-CVE-003 FE half).
 * Inherits all Hydrata performance overrides from karma.conf.single-run.js
 * but overrides the test entry to point at the SanitizeUtils suite only.
 */
...
const testWebpackPath = path.join(appDirectory, 'tests-sanitize-scoped.webpack.js');
