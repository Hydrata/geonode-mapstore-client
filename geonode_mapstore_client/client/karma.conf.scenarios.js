/**
 * Scoped karma config for the ANUGA scenario-config suite (TASK-2038, epic
 * 2037 W1). Mirrors karma.conf.clickdisambig.js — inherits all Hydrata
 * performance overrides from karma.conf.single-run.js but overrides the
 * test entry to point at a single scoped test file.
 */
...
const testWebpackPath = path.join(appDirectory, 'tests-scenarios-scoped.webpack.js');
