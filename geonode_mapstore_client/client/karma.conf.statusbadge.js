/**
 * Scoped karma config for the SimpleView StatusBadge suite (TASK-2689, epic 2662).
 ...
 *
 * Run: npx karma start karma.conf.statusbadge.js --colors
...
const testWebpackPath = path.join(appDirectory, 'tests-statusbadge-scoped.webpack.js');
